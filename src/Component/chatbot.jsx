...
const Chatbot = () => {
  ...
  const generateBotResponse = (userInput) => {
    ...
    const responses = {
      ...
      "what is this website": createLink("🏠 Welcome to the Apartment & Studio Rent website! We help users find and rent apartments or studios easily. Explore now:", "/"),
      "how does this website work": createLink("🔍 Our website allows you to search, compare, and rent apartments or studios. Use filters to find your ideal home!", "/FindaStay"),
      "admin dashboard access": createLink("⚙️ The Admin Dashboard lets you manage listings and users. Go to:", "/admin"),
  
      // Accommodation questions
      "availability of accommodations in jordan": createLink("🏨 Jordan offers diverse accommodations from hotels to apartments. Explore options here:", "/FindaStay"),
      "summary of accommodations in jordan": createLink("🏘️ Jordan has various housing options including hotels, hostels, and furnished apartments. Check our listings:", "/FindaStay"),
      "how to book": createLink("📅 You can book easily through our website. Visit:", "/FindaStay"),
      "choose a suitable place": createLink("🏠 Browse our listings to find the perfect accommodation:", "/FindaStay"),
      "rental prices in jordan": createLink("💰 Rental prices vary by location and property type. Check the latest listings:", "/FindaStay"),
      "short-term vs long-term rental": createLink("📆 Short-term rentals are flexible but costly, while long-term rentals are stable and budget-friendly. Explore your options:", "/FindaStay"),
  
      // General rental questions
      "how to rent an apartment": createLink("📝 To rent an apartment, browse listings, contact the owner, and sign a lease agreement. Start here:", "/FindaStay"),
      "documents needed for renting": createLink("📄 Typically, you need an ID, proof of income, and a rental agreement. Check more details:", "/guide"),
      "tips for first-time renters": createLink("🔑 Budget wisely, check the contract, and inspect the place before moving in. Learn more:", "/tips"),
      ...
      "how to contact site owners": createLink("📞 Contact the site owners through:", "/contact"),
      "number of visitors": "👥 The current number of active users on our platform is over 5,000!",
      "landlord services": createLink("🏡 List your property and manage rentals easily with our Landlord Portal:", "/landlord"),
      "tenant rights in jordan": createLink("⚖️ Tenants in Jordan have rights regarding rent, contracts, and evictions. Read more:", "/rights")
    };
    ...
    try {
      const res = await axios.post("https://api.openai.com/v1/chat/completions", {
        ...
        messages: [
          { 
            role: "system", 
            content: "You are a helpful assistant for an apartment rental website. Provide brief, friendly responses about accommodations in Jordan." 
          }, 
          { 
            role: "user", 
            content: userInput 
